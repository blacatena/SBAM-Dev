...
public class AuthenticationExportCustomers {
		...
		public AuthenticationExportCustomers(ExportController controller, ExportProcessReport exportProcessReport) {
		...
		public void exportCustomers() throws IOException {
			...
			try {
				...
				e.printStackTrace();
				exportReport.addError(e.getMessage());
				exportReport.setCompleted("terminated with a SQL error");
			} catch (Exception e) {
				e.printStackTrace();
				exportReport.addError(e.getMessage());
				exportReport.setCompleted("terminated with an error");
			}
