...
public class AgreementAuthMethodSearchPortlet extends GridSupportPortlet<AuthMethodTuple> implements AppSleeper, AppPortletRequester {
...
//		searchPanel.setHeight(540);
	...
	public void setPortletRenderValues() {
		setHeading("Agreement Method Search");
	...
	public String getPresenterToolTip() {
		...
		if (filter != null && filter.length() > 0)
			return "Agreement Authentication Method search for '" + filter + "'";
		return "Search for agreement authentication methods.";
	}
...
//		loadConfig.set("id", filter);
	...
	public void invokeSearchService(PagingLoadConfig loadConfig, long searchSyncId, AsyncCallback<SynchronizedPagingLoadResult<AuthMethodTuple>> myCallback) {
		grid.mask("Searching for agreements authentication methods...");
