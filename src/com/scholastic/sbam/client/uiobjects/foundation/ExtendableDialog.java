package com.scholastic.sbam.client.uiobjects.foundation;import com.extjs.gxt.ui.client.GXT;
...
/**
 * This customized version of GXT Dialog simple re-implements the original code, but extends ExtendableWindow and makes all 
 * private members and methods protected, so that the class can be properly extended.
 * 
 * @author Bob Lacatena
 *
 */
public class ExtendableDialog extends ExtendableWindow {
